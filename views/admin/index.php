...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <form action="../../php/data/form-correct-admin.php" method="post" class="bg-white p-4 rounded shadow-sm">
            <fieldset>
        ...
        <div class="d-flex justify-content-center mt-4">
            ...
            <a href="../auth/shop.php" class="btn btn-secondary">Volver a la tienda</a>
        </div>
    </div>
