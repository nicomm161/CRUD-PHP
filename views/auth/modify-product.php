...
<body class="bg-light">
    <div class="container mt-5">
        <h1 class="text-center mb-4">Modificar Animal</h1>
        <form action="../../php/data/modificar-producto.php" method="post" class="bg-white p-4 rounded shadow-sm">
            <fieldset>
                <legend class="mb-3">Modificar Animal</legend>
                <div class="mb-3">
